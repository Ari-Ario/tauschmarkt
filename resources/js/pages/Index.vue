<template>
      ...
      <div class="bg-white">
        <div>
          ...
          <TransitionRoot as="template" :show="mobileFiltersOpen">
            <Dialog as="div" class="relative z-40 lg:hidden" @close="closeMobileFilters">
              <TransitionChild
                as="template"
                ...
                >
                  <DialogPanel class="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                    <div class="flex items-center justify-between px-4">
                      ...
                      <button type="button" class="-mr-2 flex h-10 w-10 items-center justify-center rounded-md bg-white p-2 text-gray-400" @click="closeMobileFilters">
  ...
  watch([selectedBrands, selectedCategories], updateFilteredProducts)
