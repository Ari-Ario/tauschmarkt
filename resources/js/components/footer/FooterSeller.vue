...
<template>
    <footer class="footer">
      <div class="footer-item">
        ...
        <router-link :to="{ name: 'map'}" class="link"><span>Betriebsort</span></router-link>
      </div>

      <div class="footer-item">
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#298E46"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>
          <router-link :to="{ name: 'addProduct'}" class="link"><span>Ware </span></router-link>
        </div>
